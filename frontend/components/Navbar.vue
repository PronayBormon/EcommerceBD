                    ...
                    <div class="col-lg-3 col-md-4 col-8">
                        <div class="logo nav_tab">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <ul>
                                                    ...
                                                    <li v-if="loggedIn">
                                                        <nuxt-link to="#"><i
                                                                class="fa-solid fa-ticket-simple"></i>Voucher
                                                        </nuxt-link>
                                                    </li>
                                                    <li v-if="loggedIn">
                            ...
                            <div class="nav_bar tab_show" style="@media(max-width: 768px){display: none;}">
                                <button type="button" class="btn_menu"><i
                                        class="fa-solid fa-bars-staggered"></i></button>
                                                ...
                                                <div class="sub_menu">
                                                    <div class="row"
                                                        ...
                                                        <div class="col-4" v-for="childCategory in category.children"
                                                            :key="childCategory.id">
                                                            <h6><a href="#"
                                                                    @click="redirectCategory(childCategory.slug)"> {{
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li v-if="loggedIn && userRole === 3">
                                        <Nuxt-link class="dropdown-item"
                                            to="/seller/seller-wishlist">Wishlist</Nuxt-link>
                                    </li>

            ...
            <div class="col-md-8">
              <div class="delivery_addreess">
                ...
                <div class="address">
                  ...
                  <div>
                    <p v-if="getDatas.address_1 !== null">{{ shipp_address }}</p>
                    <p v-else>Please add your address</p>
                  </div>
                  <div>
                    <select v-if="getDatas.address_1 !== null && getDatas.address_1 !== ''" v-model="shipp_address"
                      @change="updateSelectedData()" style="padding: 3px; font-size: 12px; height: 20px">

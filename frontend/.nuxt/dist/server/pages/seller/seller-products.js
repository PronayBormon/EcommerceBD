exports.ids = [104,17,18,19,21,25,28,29,33,100];
exports.modules = {
...
module.exports.__inject__ = function (context) {
  add("104d1c73", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_seller_products_vue_vue_type_style_index_0_id_df4e0502_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(110);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_seller_products_vue_vue_type_style_index_0_id_df4e0502_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_seller_products_vue_vue_type_style_index_0_id_df4e0502_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_seller_products_vue_vue_type_style_index_0_id_df4e0502_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_seller_products_vue_vue_type_style_index_0_id_df4e0502_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".top_search_box[data-v-df4e0502]{background:#fff;border-radius:5px;box-shadow:0 0 20px #ededed;margin-bottom:10px;margin-top:10px;padding:0}.loading-indicator[data-v-df4e0502]{background-color:hsla(0,0%,100%,.8);height:100%;left:0;position:fixed;top:0;width:100%;z-index:9999}.loader-container[data-v-df4e0502],.loading-indicator[data-v-df4e0502]{align-items:center;display:flex;justify-content:center}.loader-container[data-v-df4e0502]{flex-direction:column;height:100vh;position:relative}.loader-text[data-v-df4e0502]{margin:0}.loader-top[data-v-df4e0502]{top:0}.loader-bottom[data-v-df4e0502]{bottom:0}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/seller/seller-products.vue?vue&type=template&id=df4e0502&scoped=true&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('LogoAndPayment'), _vm._ssrNode(" "), _c('navbarSecond'), _vm._ssrNode(" "), _vm._ssrNode("<section class=\"main_content\" data-v-df4e0502>", "</section>", [_vm._ssrNode("<div class=\"container\" data-v-df4e0502>", "</div>", [_vm._ssrNode("<div class=\"row\" data-v-df4e0502>", "</div>", [_vm._ssrNode("<div class=\"col-md-4\" data-v-df4e0502>", "</div>", [_c('SellerLeftsidebar')], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-md-8\" data-v-df4e0502>", "</div>", [_vm._ssrNode("<div class=\"top_filter\" data-v-df4e0502><h4 data-v-df4e0502>Product Management</h4> <div class=\"returns_alert\" data-v-df4e0502><div class=\"alert alert-primary\" data-v-df4e0502><i class=\"fa-solid fa-exclamation\" data-v-df4e0502></i>Since we have upgraded the product management, For a better experience, the older operation of file uploading on the current page would be offline in a few days. You can experience the new one in the menu 'Products / Bulk Add/Edit Products'\r\n                                Your products are not yet visible to buyers. Please add address to make them visible</div></div> <ul data-v-df4e0502><li data-v-df4e0502><button type=\"button \" class=\"active\" data-v-df4e0502>All</button></li> <li data-v-df4e0502><button type=\"button\" data-v-df4e0502>Online(0)</button></li> <li data-v-df4e0502><button type=\"button\" data-v-df4e0502>Draft(0)</button></li> <li data-v-df4e0502><button type=\"button\" data-v-df4e0502>Pending QC(0)</button></li> <li data-v-df4e0502><button type=\"button\" data-v-df4e0502>Out Of stock(0)</button></li> <li data-v-df4e0502><button type=\"button\" data-v-df4e0502>Inactive(0)</button></li></ul></div> "), _vm._ssrNode("<div data-v-df4e0502>", "</div>", [_c('Nuxt-link', {
    staticClass: "btn_download mb-2",
    attrs: {
      "to": "/seller/seller-products-post"
    }
  }, [_vm._v("Add New ")])], 1), _vm._ssrNode(" <div class=\"top_search_box\" data-v-df4e0502><form action data-v-df4e0502><div class=\"row\" data-v-df4e0502><div class=\"col-xl-3 col-lg-4 col-md-6 col-sm-6 col-6\" data-v-df4e0502><input type=\"text\" placeholder=\"Product Id\"" + _vm._ssrAttr("value", _vm.productId) + " data-v-df4e0502></div> <div class=\"col-xl-3 col-lg-4 col-md-6 col-sm-6 col-6\" data-v-df4e0502><input type=\"text\" placeholder=\"Product Name \"" + _vm._ssrAttr("value", _vm.productName) + " data-v-df4e0502></div> <div class=\"col-xl-3 col-lg-4 col-md-6 col-sm-6 col-6\" data-v-df4e0502><input type=\"text\" placeholder=\"SKU \"" + _vm._ssrAttr("value", _vm.sku) + " data-v-df4e0502></div> <div class=\"col-xl-3 col-lg-4 col-md-6 col-sm-6 col-6\" data-v-df4e0502><button type=\"button\" class=\"btn_cart\" style=\"visibility: unset; color: #fff; width: fit-content;\" data-v-df4e0502>Search </button></div></div></form></div> "), _vm.loading ? _vm._ssrNode("<div class=\"loading-indicator\" data-v-df4e0502>", "</div>", [_vm._ssrNode("<div class=\"loader-container\" data-v-df4e0502>", "</div>", [_c('center', {
    staticClass: "loader-text"
  }, [_vm._v("Loading...")]), _vm._ssrNode(" <img src=\"/loader/loader.gif\" alt=\"Loader\" data-v-df4e0502>")], 2)]) : _vm._e(), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"main_profile\" data-v-df4e0502>", "</div>", [_vm._ssrNode("<div class=\"user_details order_details_table\" data-v-df4e0502>", "</div>", [_vm._ssrNode("<table class=\"table\" data-v-df4e0502>", "</table>", [_vm._ssrNode("<thead data-v-df4e0502><tr data-v-df4e0502><th data-v-df4e0502>#</th> <th data-v-df4e0502>Product ID</th> <th data-v-df4e0502>Name</th> <th data-v-df4e0502>SKU</th> <th data-v-df4e0502>Price </th> <th data-v-df4e0502>Status</th> <th class=\"text-center\" data-v-df4e0502>Action</th></tr></thead> "), _vm._ssrNode("<tbody data-v-df4e0502>", "</tbody>", _vm._l(_vm.products, function (product, index) {
    return _vm._ssrNode("<tr data-v-df4e0502>", "</tr>", [_vm._ssrNode("<td data-v-df4e0502>" + _vm._ssrEscape(_vm._s(index + 1)) + "</td> <td data-v-df4e0502>" + _vm._ssrEscape(_vm._s(product.id)) + "</td> "), _vm._ssrNode("<td class=\"table_product\" data-v-df4e0502>", "</td>", [_vm._ssrNode("<div data-v-df4e0502><img" + _vm._ssrAttr("src", product.image) + " alt class=\"img-fluid\" data-v-df4e0502></div> "), _vm._ssrNode("<div data-v-df4e0502>", "</div>", [_c('nuxt-link', {
      attrs: {
        "to": `/product-details/${product.slug}`
      }
    }, [_c('h6', [_vm._v(_vm._s(product.name))])])], 1)], 2), _vm._ssrNode(" <td data-v-df4e0502>" + _vm._ssrEscape(_vm._s(product.sku)) + "</td> <td data-v-df4e0502>" + _vm._ssrEscape(_vm._s(`${product.price}TK`)) + "</td> <td data-v-df4e0502>" + _vm._ssrEscape(_vm._s(product.status)) + "</td> <td data-v-df4e0502><span data-v-df4e0502><button type=\"button\" class=\"btn_edit_nxt\" data-v-df4e0502><i class=\"fa-solid fa-pen-to-square\" data-v-df4e0502></i></button></span> <span data-v-df4e0502><button type=\"button\" class=\"btn_edit_nxt\" data-v-df4e0502><i class=\"fa-solid fa-magnifying-glass-plus\" data-v-df4e0502></i></button></span></td>")], 2);
  ...
  }, [_vm.loading ? _c('span', [_vm._v("Loading...")]) : _c('span', [_vm._v("Load More...")])])])], 2)])], 2)], 2)])]), _vm._ssrNode(" <div class=\"back_top\" data-v-df4e0502><a href=\"#top\" data-v-df4e0502><i class=\"fa-solid fa-angle-up\" data-v-df4e0502></i></a></div> "), _c('Footer')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/seller/seller-products.vue?vue&type=template&id=df4e0502&scoped=true&
